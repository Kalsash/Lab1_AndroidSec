...
import com.google.firebase.example.makeitso.ui.GoogleSignInScreen

// Добавляем новый маршрут
object GoogleRoute {
    const val route = "google"
}
                ...
                Surface(
                    ...
                    Scaffold(
                        ...
                        floatingActionButton = {
                            FloatingActionButton(
                                onClick = {
                                    navController.navigate(GoogleRoute.route) { launchSingleTop = true }
                                }
                            ) {
                                Icon(Icons.Default.Check, contentDescription = "Привет")
                            }
                        }
                    ) { innerPadding ->
                        NavHost(
